#!/bin/bash
# Export evaluation files as base64 - FORCE UTF-8 encoding
...
echo "Original file size: $(wc -c < predictions_formatted.txt) bytes"
echo ""
...
echo "Original file size: $(wc -c < data/public_test_ground_truth.txt) bytes"
echo ""
...
echo "Original file size: $(wc -c < public_test_result_baseline_7b.txt) bytes"
echo ""
...
echo "=========================================="
echo ""
echo "✓ All files encoded to base64 with UTF-8"
echo ""
